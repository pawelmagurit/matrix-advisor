"""Synthetic profiles for unit tests only — not used in production data."""
...
def generate_sample_data(out_dir: Path, count: int = 24) -> Path:
    """Create synthetic pictograms + CSV manifests under out_dir (tests only)."""
    pictograms = out_dir / "pictograms"
    ...
    matrices_path = out_dir / "matrices.csv"
